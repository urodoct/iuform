...
#'
#' @export
new_slider <- function(label, must_fill=F, section){
  ...
  part1 <- glue::glue("  sliderInput('{element_name}', {if(must_fill)return ('labelMandatory') else return ('')}('{element_name}'), '{blanky}'),",)
