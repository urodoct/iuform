...
#'
#' @export
new_freetext <- function(label, must_fill=F, section){
  ...
  part1 <- glue::glue("  textInput('{element_name}', {if(must_fill)return ('labelMandatory') else return ('')}('{element_name}'), '{blanky}'),",)
